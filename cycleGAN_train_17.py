...
def main():
    ...
    parser.add_argument("--model-name", type=str, default="cyclegan_v17")
    ...
    #lr_scheduler_G = torch.optim.lr_scheduler.LambdaLR(G_optim, lr_lambda=lambda epoch: 0.95 ** epoch)
